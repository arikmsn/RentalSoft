      ...
      sites.map(async (site) => {
        ...
        return {
          ...
          workOrders: site.workOrders.map(wo => ({
            ...
            plannedRemovalDate: wo.plannedRemovalDate,
            isNextVisitPotentialRemoval: wo.isNextVisitPotentialRemoval || false,
          })),
          equipmentCount,
          hasPotentialRemoval: site.workOrders.some(wo => wo.isNextVisitPotentialRemoval && wo.plannedRemovalDate),
