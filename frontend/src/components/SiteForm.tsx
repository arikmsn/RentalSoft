...
export function SiteForm({
  ...
  return (
    <div className={inline ? "bg-surface-50 p-4 rounded-xl border border-surface-200" : "fixed inset-0 bg-surface-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4"}>
      <div className={inline ? "w-full" : "bg-white rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto shadow-float"}>
        {!inline && (
